...
// const REACT_APP_HOST = "https://tourtravelbackend-production-d581.up.railway.app";
const REACT_APP_HOST = "https://tour-travel-backend-xcz0.onrender.com";
...
const USE_DISCOUNT = REACT_APP_HOST + '/api/discounts/useDiscount'
...
export { REACT_APP_HOST,GET_ALL_TOUR, CHECK_ACCOUNT_EXISTS, CHECK_USER_EXISTS, BOOKING_TOUR, GET_PAGE_BOOKING, 
  ...
  TOUR_GUIDE,GET_DISCOUNT_TOUR,ITINERARY_BOOKING_TOUR, USE_DISCOUNT,TOUR_SIMPLE, TOUR_PROVIDER_DETAILS,REVIEW_USER_STATISTICS,LOGIN_WITH_EMAIL,GET_ALL_DEPARTURE,ASSIGNMENT_TOURGUIDE,BOOKING_DETAIL,REFRESH_TOKEN_ENDPOINT,LOG_OUT,GET_BOOKING_ID,GET_BOOKING_BY_TOUR,getAPI };