...
const scriptChatbot = (key, lstProvince) => {
    ...
    return check
      ? {
          ...
          data: [
            {
              me: false,
              content: `Bạn muốn tham gia tour ở ${check}`,
              createDate: new Date(),
            },
            {
              me: false,
              content: constantManage.VIEW_TOUR,
              onClick: constantManage.VIEW_TOUR,
            },
            {
              me: false,
              content: constantManage.SELECT_TOUR_TYPE,
              onClick: constantManage.SELECT_TOUR_TYPE,
            },
          ],
        }
      : {
          ...
          data: [
            {
              me: false,
              content:
                "Xin lỗi tôi không biết thành phố bạn đã chọn, bạn hãy nhập lại!",
              createDate: new Date(),
            },
          ],
        };
  ...
  if (index !== -1) return valueRep[index];
  return [
    {
      me: false,
      content: "Xin lỗi, tôi không thể hiểu ý của bạn, bạn muốn làm gì?",
      createDate: new Date(),
    },
