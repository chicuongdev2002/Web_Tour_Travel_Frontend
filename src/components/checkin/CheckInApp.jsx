          ...
          >
            ...
            <CardContent sx={{ p: 3 }}>
                  ...
                  >
                    <Button
                      ...
                      sx={{
                        ...
                        borderRadius: 2,
                        background:
                          "linear-gradient(to right, #1976d2, #4791db)",
                        "&:hover": {
                          background:
                            "linear-gradient(to right, #4791db, #1976d2)",
                        },
                      }}
                    >
              ...
              >
                <Alert
                  severity={
                    checkInStatus?.status === "success" ? "success" : "error"
                  }
                  icon={
                    ...
                    <Card variant="outlined" sx={{ mb: 2 }}>
                      <CardContent>
                        <Typography variant="body1" gutterBottom>
                          ...
                          {checkInStatus.booking.bookingId}
                        </Typography>
                        <Divider sx={{ my: 1 }} />
                        <Typography variant="body1" gutterBottom>
                          <strong>Người đặt:</strong>{" "}
                          {checkInStatus.booking.user.fullName}
                        </Typography>
                        <Divider sx={{ my: 1 }} />
                        <Typography variant="body1" gutterBottom>
                          <strong>Đại lý:</strong>{" "}
                          {checkInStatus.booking.departure.tour.user.fullName}
                        </Typography>
                        <Divider sx={{ my: 1 }} />
                        ...
                        <Typography variant="body1">
                          ...
                          {checkInStatus.booking.departure.startDate}
                        </Typography>
                        <Divider sx={{ my: 1 }} />
                        <Typography variant="body1">
                          <strong>Ngày kết thúc:</strong>{" "}
                          {checkInStatus.booking.departure.endDate}
                        </Typography>
                      </CardContent>
                    </Card>
                  </DialogContent>
