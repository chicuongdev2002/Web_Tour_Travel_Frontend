...
const AdminDashboard = () => {
  ...
  const navigation = [
    ...
    },
    {
      ...
      icon: <CalendarIcon />,
      children: [
        { name: 'Danh sách đặt tour', path: '/admin/booking-list' },
      ],
    },
    {
      id: 'user',
 ...
 const getBreadcrumbName = (path) => {
  ...
  return pathNameMap[currentPath] || currentPath.charAt(0).toUpperCase() + currentPath.slice(1).replace('-', ' ');
};
      ...
      <List sx={{ flexGrow: 1, px: 2 }}>
        {navigation.map((group) => (
          <Box key={group.id} sx={{ mb: 0.5 }}>
            ...
            <Collapse in={expandedMenu === group.id} timeout="auto" unmountOnExit>
      ...
      >
        ...
        <Routes>
          ...
          <Route path="/statis-tourguide" element={<TourGuideStats />} />
           <Route path="/statis-tour-reiview" element={<TourStatisticsDashboard />} />
        </Routes>
      </Box>
