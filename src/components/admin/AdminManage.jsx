...
function AdminPage({ changeTitle }) {
  ...
  return (
    <div
      ...
      className="w-100 divRowBetweenNotAlign"
    >
      <div
      ...
      >
        ...
        <div
          className={`divRow ${select == "KPI" ? "elementSelected" : "element"}`}
        >
          <IoIosAlarm size={30} />
          {isOpen && (
            <p className="one-line-text" onClick={() => handleSelect("KPI")}>
              Quản lý KPI
            </p>
          )}
        </div>
