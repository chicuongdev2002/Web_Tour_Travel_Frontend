  ...
  const convertData = useCallback((data) => {
    ...
    return data?.map((d) => {
      return {
        ...
        Tour: {
          title: d.booking.departure.tour.tourName,
          onClick: () => {
        ...
        "Thời gian":
          new Date(d.booking.departure.startDate).toLocaleDateString() +
          "-" +
          new Date(d.booking.departure.endDate).toLocaleDateString(),
        ...
        "Trạng thái": {
          ...
          onClick: () => {
            setSelectedStatus({
              id: d.booking.bookingId,
              active: d.booking.active,
            });
            setNotify(2);
          },
        },
    ...
    if (dataUser)
      data = [
        { label: { icon: <FaUser /> }, value: dataUser.user.fullName },
        {
          ...
          value: dataUser.user.phoneNumber,
        },
      ...
      data = [
        ...
        { label: "Tour: ", value: dataBooking.departure.tour.tourName },
        {
          label: "Thời gian: ",
          value:
            new Date(dataBooking.departure.startDate).toLocaleDateString() +
            "-" +
            new Date(dataBooking.departure.endDate).toLocaleDateString(),
        },
        {
          label: "Vị trí bắt đầu: ",
          value: dataBooking.departure.tour.startLocation,
        },
        {
          label: "Số chỗ: ",
        ...
        {
          label: "Ngày đặt: ",
          value: new Date(dataBooking.bookingDate).toLocaleString(),
        },
        {
          label: "Thanh toán: ",
          value: dataBooking.paymentDate ? "Đã thanh toán" : "Chưa thanh toán",
        },
        {
          label: "Trạng thái: ",
