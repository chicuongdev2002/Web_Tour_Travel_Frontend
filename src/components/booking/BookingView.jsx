                ...
                booking.bookingId? 
                      <div>
                          ...
                          <div className='divRowBetweenNotAlign px-4'>
                              ...
                              <h5 className='p-0'>{booking.user?.userId} - {booking.user?.fullName} - {booking.user?.phoneNumber}</h5>
                          </div>
                          <div className='divRowBetweenNotAlign px-4'>
                          ...
                          <div className='divRowBetweenNotAlign px-4'>
                              ...
                              <h5 className='p-0'>{formatDate(booking.departure?.startDate ?? '')}</h5>
                          </div>
                          <div className='divRowBetweenNotAlign px-4'>
                          ...
                          <div className='divRow justify-content-center w-100 my-2'>
                              <button className='btn btn-primary' onClick={handleCancel}>Huỷ</button>
