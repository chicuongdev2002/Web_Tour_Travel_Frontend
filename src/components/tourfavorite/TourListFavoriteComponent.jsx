...
const TourListFavoriteComponent = () => {
  ...
  const sliderStyles = {
    ...
    padding: '24px',
    animation: isPaused ? 'none' : `scroll ${ANIMATION_DURATION}ms linear infinite`,
    '&:hover': {
      animationPlayState: 'paused'
    },
    '@keyframes scroll': {
      '0%': { transform: 'translateX(0)' },
      '100%': { transform: `translateX(-${CARD_WIDTH * (tours.length / 2) + (24 * (tours.length / 2))}px)` }
    }
  };
              ...
              >
                ...
                <CardContent sx={{ flexGrow: 1, p: 2 }}>
                  ...
                  <Box sx={{ display: 'flex', gap: 1, mb: 3, flexWrap: 'wrap' }}>
                    ...
                    <Tooltip title="Số chỗ còn trống" TransitionComponent={Zoom}>
                      <Chip 
                        icon={<People />} 
                        ...
                        sx={{
                          transition: 'all 0.3s ease',
                          '&:hover': {
                            backgroundColor: tour.availableSeats < 5 ? 'error.light' : 'primary.light',
                            color: 'white',
                            '& .MuiChip-icon': {
                              color: 'white'
                            }
