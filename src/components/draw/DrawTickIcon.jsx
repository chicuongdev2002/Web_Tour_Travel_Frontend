...
function DrawTickIcon({ width, color }) {
  ...
  return (
    <motion.svg width={width} height={width} viewBox={`0 0 ${width} ${width}`} initial="hidden" animate="visible">
      ...
      <DrawLine x1={line1.x1} y1={line1.y1} x2={line1.x2} y2={line1.y2} color={color} custom={0.5} duration={0.5}/>
      <DrawLine x1={line2.x1} y1={line2.y1} x2={line2.x2} y2={line2.y2} color={color} custom={1} duration={0.5}/>
    </motion.svg>
  );
}
