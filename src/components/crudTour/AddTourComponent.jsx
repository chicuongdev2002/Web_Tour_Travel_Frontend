        ...
        <div className=" w-30 border border-primary m-2 formBooking">
          ...
          <div>
            ...
            <InputText
              ...
              onChange={(e) => {
                if (e.target.value < 1) setMaxParticipants(1);
                else setMaxParticipants(e.target.value);
              }}
            />
            <InputText
              label="Thời gian(giờ)"
            ...
            <div className="divRowBetween">
              <div className="w-30">
                <InputText
                  ...
                  value={childrenPrice}
                  onChange={(e) => {
                    if (e.target.value < 0) setChildrenPrice(0);
                    else setChildrenPrice(e.target.value);
                  }}
                />
              </div>
              <div className="w-30">
                <InputText
                  ...
                  value={adultPrice}
                  onChange={(e) => {
                    if (e.target.value < 0) setAdultPrice(0);
                    else setAdultPrice(e.target.value);
                  }}
                />
              </div>
              <div className="w-30">
                <InputText
                  ...
                  value={oldPrice}
                  onChange={(e) => {
                    if (e.target.value < 0) setOldPrice(0);
                    else setOldPrice(e.target.value);
                  }}
                />
              </div>
            </div>
