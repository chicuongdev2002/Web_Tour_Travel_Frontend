      ...
      {itineraries.map((tour, index) => (
        <Zoom in={true} style={{ transitionDelay: `${index * 150}ms` }}>
          <TimelineItem key={tour.tourId}>
            ...
            <TimelineContent
              sx={{ py: isMobile ? 2 : 3, px: isMobile ? 2 : 3 }}
            >
              <Box
                sx={{
                  background: "#fff",
                ...
                <Box sx={{ p: 3 }}>
                  <Typography
                    ...
                    sx={{
                      ...
                      mb: 2,
                      textDecoration: isTourPassed(tour.departures[0].startDate)
                        ? "line-through"
                        : "none",
                      opacity: isTourPassed(tour.departures[0].startDate)
                        ? 0.7
                        : 1,
                    }}
                  >
    ...
    >
      ...
      >
        ...
        {destinations.map((dest, index) => (
          <Marker key={index} position={dest.coordinates}>
            <Popup>
  ...
  useEffect(() => {
    const fetchItinerary = async () => {
      try {
        ...
        setDestinations(
          destinationsWithCoordinates.filter(
            (dest) => dest.coordinates !== null,
          ),
        );
          ...
          <Box>
            ...
            >
              ...
              <Box sx={{ position: "relative" }}>
                ...
                >
                  Khám phá hành trình tuyệt vời đang chờ đợi bạn qua timeline và
                  bản đồ tương tác
                </Typography>
                    ...
                    >
                      ...
                      >
                        ...
                        <Box>
                          <Typography variant="h6">
                            {formatDate(
                              itineraries[0]?.departures[0]?.startDate,
                            )}
                          </Typography>
